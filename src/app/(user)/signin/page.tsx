  ...
  return (
    <Container className="py-20 flex flex-col justify-center items-center">
      <form
        ...
        className="flex items-center gap-1 border border-blue-500 font-semibold bg-blue-50 text-black px-4 py-1.5 rounded-md hover:bg-blue-800 hover:text-white hoverEffect transition-all duration-300"
      >
        <Image src={google} alt="google" className="w-8" />
